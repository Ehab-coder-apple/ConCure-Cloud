...
class FoodsImport implements ToCollection, WithHeadingRow, WithBatchInserts, WithChunkReading
{
            ...
            try {
                ...
                try {
                    Food::create([
                        ...
                        'grams_per_piece' => isset($row['grams_per_piece']) && is_numeric($row['grams_per_piece']) ? (float)$row['grams_per_piece'] : null,
    ...
    public static function getExpectedHeaders(): array
    {
        return [
            ...
            'grams_per_piece' => 'Grams per piece (Optional; used when unit = piece)',
