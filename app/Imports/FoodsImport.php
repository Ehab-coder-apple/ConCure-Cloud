...
class FoodsImport implements ToCollection, WithHeadingRow, WithBatchInserts, WithChunkReading
{
    ...
    public static function getExpectedHeaders(): array
    {
        return [
            ...
            'meal_types' => 'Meal Types (Optional: comma-separated e.g. "breakfast, lunch"; blank or "any" = all)',
            'meal_type' => 'Meal Type (Optional; single value; legacy: breakfast, lunch, dinner, snack, any)',
