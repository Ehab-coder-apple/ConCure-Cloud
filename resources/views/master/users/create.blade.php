                    ...
                    <form action="{{ route('master.users.store') }}" method="POST">
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                           ...
                                           value="{{ old('managed_clinic_limit', 0) }}">
                                    <div class="form-text">Set how many new clinics this Super Admin is allowed to create, manage, and delete in addition to any allocated clinics.</div>
                            ...
                            <div class="col-md-4 mt-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                           ...
                                           value="{{ old('managed_user_limit', 1) }}">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <p class="text-muted small mb-3">Choose which clinic modules this scoped Super Admin may open. Unchecked modules stay hidden and blocked even if enabled on an assigned clinic.</p>
                                @php($selectedModules = old('permitted_modules', array_keys($availableModules ?? [])))
                            </div>
