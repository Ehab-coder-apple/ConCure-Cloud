                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control @error('contract_renewal_at') is-invalid @enderror" id="contract_renewal_at" name="contract_renewal_at" value="{{ old('contract_renewal_at', optional($clinic->contract_renewal_at)->toDateString()) }}">
