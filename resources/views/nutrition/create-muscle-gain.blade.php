...
<div class="container" style="margin-top: 80px;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="h3 mb-0">
                        ...
                        {{ __('Create Muscle Gain Nutrition Plan') }}
                    </h1>
                    <p class="text-muted mb-0">{{ __('Design a specialized muscle gain nutrition plan for your patient') }}</p>
                </div>
                <div>
            ...
            <div class="card border-primary">
                <div class="card-header bg-primary text-white">
                    <h6 class="mb-0">
                        ...
                        {{ __('Muscle Gain Template Information') }}
                    </h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <h6 class="text-primary">{{ $template['title'] }}</h6>
                            ...
                            <div class="row text-center">
                                <div class="col-6 mb-3">
                                    <div class="bg-light p-3 rounded">
                                        <div class="h4 text-primary mb-1">{{ $template['target_calories'] }}</div>
                                        <small class="text-muted">{{ __('Calories/day') }}</small>
                                    </div>
                                </div>
                                <div class="col-6 mb-3">
                                    <div class="bg-light p-3 rounded">
                                        <div class="h4 text-primary mb-1">{{ $template['duration_days'] }}</div>
                                        <small class="text-muted">{{ __('Days') }}</small>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="bg-light p-3 rounded">
                                        <div class="h4 text-primary mb-1">{{ $template['target_protein'] }}g</div>
                                        <small class="text-muted">{{ __('Protein') }}</small>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="bg-light p-3 rounded">
                                        <div class="h4 text-primary mb-1">{{ $template['target_carbs'] }}g</div>
    ...
    <form action="{{ route('nutrition.store') }}" method="POST">
        @csrf
        <input type="hidden" name="template_type" value="muscle_gain">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-primary">
                            <small>
                                ...
                                {{ __('These values are pre-filled based on the muscle gain template. You can adjust them as needed for the specific patient.') }}
                            </small>
                        </div>
                    </div>
                </div>
