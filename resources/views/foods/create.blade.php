        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="text-muted">{{ __('Add a new food item to the composition database') }}</p>
                </div>
                <div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control @error('food_group_id') is-invalid @enderror"
                                        ...
                                        @foreach($foodGroups as $group)
                                            <option value="{{ $group->id }}" {{ old('food_group_id') == $group->id ? 'selected' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> {{ __('Save Food') }}
                            </button>
                        </div>
                    </div>
                </div>
