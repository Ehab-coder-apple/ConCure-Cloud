                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('meal_type') is-invalid @enderror" id="meal_type" name="meal_type">
                                @php $currentMealType = old('meal_type', $food->meal_type ?? 'any'); @endphp
                                <option value="any" {{ $currentMealType == 'any' ? 'selected' : '' }}>{{ __('Any Meal') }}</option>
                                <option value="breakfast" {{ $currentMealType == 'breakfast' ? 'selected' : '' }}>{{ __('Breakfast') }}</option>
                                <option value="lunch" {{ $currentMealType == 'lunch' ? 'selected' : '' }}>{{ __('Lunch') }}</option>
                                <option value="dinner" {{ $currentMealType == 'dinner' ? 'selected' : '' }}>{{ __('Dinner') }}</option>
                                <option value="snack" {{ $currentMealType == 'snack' ? 'selected' : '' }}>{{ __('Snack') }}</option>
                            </select>
                            @error('meal_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
