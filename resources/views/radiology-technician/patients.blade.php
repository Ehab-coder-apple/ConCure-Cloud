...
@section('title', __('Upload Patient Radiology Results'))
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">{{ __('Search for patients and upload radiology results') }}</p>
                </div>
                <div>
                    <a href="{{ route('recommendations.radiology-technician.dashboard') }}" class="btn btn-outline-secondary">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card shadow">
                <div class="card-body">
                    <form method="GET" action="{{ route('recommendations.radiology-technician.patients') }}">
                        <div class="input-group">
                            ...
                            @if(request('search'))
                                <a href="{{ route('recommendations.radiology-technician.patients') }}" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                    @if(!request('search'))
                        ...
                        <div class="text-center py-5">
                            ...
                            <div class="alert alert-info d-inline-block" role="alert">
                                ...
                                {{ __('Search to upload results for system radiology requests or manual/verbal requests.') }}
                            </div>
                        </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('recommendations.radiology-technician.patients.files', $patient->id) }}"
                                               class="btn btn-sm btn-primary"
                                               title="{{ __('Upload Radiology Result') }}">
                    ...
                    @else
                        ...
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('recommendations.radiology-technician.patients') }}" class="btn btn-outline-primary">
                                <i class="fas fa-times me-1"></i>
                                {{ __('Clear Search') }}
                            </a>
                        </div>
