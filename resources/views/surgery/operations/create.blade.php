...
<div class="container">
    ...
    <form method="POST" action="{{ route('surgery.operations.store', $surgicalCase) }}">
        ...
        <div class="mb-3">
	        ...
	        {{-- Wound Assessment (within Post‑op Assessment) --}}
	        <hr>
	        ...
	        {{-- 4. Wound Assessment (TIME Framework) --}}
	        ...
	        <div class="row">
	            <div class="col-md-3 mb-2">
	                ...
	                <div class="form-check">
	                    <input class="form-check-input" type="checkbox" name="wound_assessment[treatment][debridement][sharp]" value="1" {{ data_get($treatOld, 'debridement.sharp') ? 'checked' : '' }}>
	                    <label class="form-check-label">Sharp</label>
	                </div>
	                <div class="form-check">
	                    <input class="form-check-input" type="checkbox" name="wound_assessment[treatment][debridement][surgical]" value="1" {{ data_get($treatOld, 'debridement.surgical') ? 'checked' : '' }}>
	                    <label class="form-check-label">Surgical</label>
	                </div>
	                <div class="form-check">
	                    <input class="form-check-input" type="checkbox" name="wound_assessment[treatment][debridement][autolytic]" value="1" {{ data_get($treatOld, 'debridement.autolytic') ? 'checked' : '' }}>
	                    <label class="form-check-label">Autolytic</label>
	                </div>
	                <div class="form-check">
	                    <input class="form-check-input" type="checkbox" name="wound_assessment[treatment][debridement][mechanical]" value="1" {{ data_get($treatOld, 'debridement.mechanical') ? 'checked' : '' }}>
	                    <label class="form-check-label">Mechanical</label>
	                </div>
	                <div class="form-check">
	                    <input class="form-check-input" type="checkbox" name="wound_assessment[treatment][debridement][enzymatic]" value="1" {{ data_get($treatOld, 'debridement.enzymatic') ? 'checked' : '' }}>
	                    <label class="form-check-label">Enzymatic</label>
	                </div>
	            </div>
	            <div class="col-md-3 mb-2">
	                <strong>Cleansing Solution</strong>
	                <div class="form-check">
	                    <input class="form-check-input" type="checkbox" name="wound_assessment[treatment][cleansing][normal_saline]" value="1" {{ data_get($treatOld, 'cleansing.normal_saline') ? 'checked' : '' }}>
	                    <label class="form-check-label">Normal saline</label>
	                </div>
	                <div class="form-check">
	                    <input class="form-check-input" type="checkbox" name="wound_assessment[treatment][cleansing][hocl]" value="1" {{ data_get($treatOld, 'cleansing.hocl') ? 'checked' : '' }}>
	                    <label class="form-check-label">Hypochlorous acid (HOCl)</label>
	                </div>
	                <div class="form-check">
	                    <input class="form-check-input" type="checkbox" name="wound_assessment[treatment][cleansing][phmb]" value="1" {{ data_get($treatOld, 'cleansing.phmb') ? 'checked' : '' }}>
	                    <label class="form-check-label">PHMB</label>
	                </div>
