...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h2><i class="fas fa-notes-medical me-2"></i>{{ __('Edit ENT Record') }}</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('ent.index') }}">{{ __('ENT Records') }}</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('ent.show', $entRecord) }}">{{ __('View') }}</a></li>
    ...
    <form action="{{ route('ent.update', $entRecord) }}" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="patient_id" id="patient_id" class="form-select @error('patient_id') is-invalid @enderror" required>
                            ...
                            <option value="{{ $patient->id }}" {{ old('patient_id', $entRecord->patient_id) == $patient->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="doctor_id" id="doctor_id" class="form-select @error('doctor_id') is-invalid @enderror" required>
                            ...
                            <option value="{{ $doctor->id }}" {{ old('doctor_id', $entRecord->doctor_id) == $doctor->id ? 'selected' : '' }}>
                                {{ $doctor->full_name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" name="visit_date" id="visit_date" class="form-control @error('visit_date') is-invalid @enderror"
                               value="{{ old('visit_date', $entRecord->visit_date->format('Y-m-d')) }}" required>
                        @error('visit_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <textarea name="chief_complaint" id="chief_complaint" rows="3" class="form-control @error('chief_complaint') is-invalid @enderror">{{ old('chief_complaint', $entRecord->chief_complaint) }}</textarea>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="ear_examination" id="ear_examination" rows="4" class="form-control @error('ear_examination') is-invalid @enderror"
                                  placeholder="Otoscopy findings, tympanic membrane, external auditory canal...">{{ old('ear_examination', $entRecord->ear_examination) }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="nose_examination" id="nose_examination" rows="4" class="form-control @error('nose_examination') is-invalid @enderror"
                                  placeholder="Nasal mucosa, septum, turbinates, discharge...">{{ old('nose_examination', $entRecord->nose_examination) }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="throat_examination" id="throat_examination" rows="4" class="form-control @error('throat_examination') is-invalid @enderror"
                                  placeholder="Oropharynx, tonsils, pharyngeal wall...">{{ old('throat_examination', $entRecord->throat_examination) }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="neck_examination" id="neck_examination" rows="4" class="form-control @error('neck_examination') is-invalid @enderror"
                                  placeholder="Lymph nodes, thyroid, masses...">{{ old('neck_examination', $entRecord->neck_examination) }}</textarea>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="cranial_nerves" id="cranial_nerves" rows="3" class="form-control @error('cranial_nerves') is-invalid @enderror">{{ old('cranial_nerves', $entRecord->cranial_nerves) }}</textarea>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <textarea name="diagnosis" id="diagnosis" rows="3" class="form-control @error('diagnosis') is-invalid @enderror">{{ old('diagnosis', $entRecord->diagnosis) }}</textarea>
                        @error('diagnosis')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="icd10_code" id="icd10_code" class="form-control @error('icd10_code') is-invalid @enderror"
                               value="{{ old('icd10_code', $entRecord->icd10_code) }}" placeholder="e.g., H66.9">
                        @error('icd10_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="treatment_plan" id="treatment_plan" rows="4" class="form-control @error('treatment_plan') is-invalid @enderror">{{ old('treatment_plan', $entRecord->treatment_plan) }}</textarea>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="medications" id="medications" rows="3" class="form-control @error('medications') is-invalid @enderror"
                                  placeholder="List medications, dosage, duration...">{{ old('medications', $entRecord->medications) }}</textarea>
                        @error('medications')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="followup_date" id="followup_date" class="form-control @error('followup_date') is-invalid @enderror"
                               value="{{ old('followup_date', $entRecord->followup_date?->format('Y-m-d')) }}">
                        @error('followup_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="notes" id="notes" rows="3" class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $entRecord->notes) }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="mb-3">
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save me-1"></i>{{ __('Update ENT Record') }}
            </button>
