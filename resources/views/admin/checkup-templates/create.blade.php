...
@section('page-title', __('Create Checkup Template'))
...
<div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0">
                        ...
                        {{ __('Create Checkup Template') }}
                    </h1>
                    <p class="text-muted mb-0">{{ __('Design a custom checkup form for specific medical conditions') }}</p>
                </div>
                <div>
    ...
    <!-- Template Form -->
    <form action="{{ route('admin.checkup-templates.store') }}" method="POST" id="templateForm">
        @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="{{ __('Describe the purpose and use of this template') }}">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
