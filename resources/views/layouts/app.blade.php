        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        [dir='rtl'] body:has(.container:has(.fas.fa-apple-alt)) .main-content {
            ...
            body.page-nutrition .main-content {
                ...
                margin-top: calc(var(--topbar-height) + 54px) !important;
                padding-top: 28px !important;
            }

            /* Safety: ensure the very first content block starts below the topbar */
            body.page-nutrition .content-wrapper > *:first-child { margin-top: 26px !important; }
            /* Nudge the nutrition container itself a bit further down for guaranteed clearance */
            body.page-nutrition #nutrition-show.container { padding-top: 18px !important; }
