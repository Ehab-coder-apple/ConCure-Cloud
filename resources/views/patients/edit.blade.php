                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control @error('date_of_birth') is-invalid @enderror" 
                                               ...
                                               value="{{ old('date_of_birth', $patient->date_of_birth_for_form) }}">
                                        @error('date_of_birth')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control @error('history_of_present_illness') is-invalid @enderror"
                                                  ...
                                                  placeholder="{{ __('Describe the history of the present illness...') }}">{{ old('history_of_present_illness', $patient->history_of_present_illness) }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Check on page load (existing patient DOB)
